<template>
  <layout :userinfo="userinfo" :notif="notif">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800">Edit Employee {{ form.nik }}</h1>
    </div>
            ...
            <b-card-body>
              ...
              <b-col col lg="6" md="auto">
                ...
                <b-form-group
                  ...
                  label="Title:"
                  label-for="input-title"
                  :invalid-feedback="errors.id_title ? errors.id_title[0] : ''"
                  :state="errors.id_title ? false : null"
                >
                  <v-select
                    label="title_name"
