              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <table class="table mt-4">
                    ...
                    <tbody>
                      <tr
                        v-for="(item, index) in dataUsers.data"
                        :key="item.id"
                      >
                        <th scope="row">
                          {{
                        ...
                        <td>
                          <b-badge v-if="item.role == 2" class="bg-danger"
                            >Super ADM</b-badge
                          >
                          <b-badge v-else-if="item.role == 1" class="bg-primary"
                            >Admin</b-badge
                          >
                          <b-badge v-else class="bg-secondary">User</b-badge>
                        </td>
                        <td>
                  ...
                  <Pagination :links="dataUsers.links" />
                </div>
              </div>
            </keep-alive>
          </b-card>
