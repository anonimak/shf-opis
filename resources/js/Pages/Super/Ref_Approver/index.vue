            ...
            <keep-alive>
              <div class="row">
                <div class="col-12">
                  ...
                  <table class="table mt-4">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">Role Approver</th>
                        <th scope="col">Action</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr
                        v-for="(item, index) in dataRefApproves.data"
                        :key="item.id"
                      >
                        <th scope="row">
                          {{
                        ...
                        <td>
                          <span
                            v-for="(detail, index) in item.detail_approver"
                            :key="detail.id"
                          >
                            {{ detail.position.position_name }}
                            <span
                              v-if="index + 1 < item.detail_approver.length"
                            >
                              >
                            </span>
                          </span>
                  ...
                  <Pagination :links="dataRefApproves.links" />
                </div>
              </div>
            </keep-alive>
          </b-card>
