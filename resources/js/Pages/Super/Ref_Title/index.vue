              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <table class="table mt-4">
                    ...
                    <tbody>
                      <tr
                        v-for="(item, index) in dataRefTitles.data"
                        :key="item.id"
                      >
                        <th scope="row">
                          {{
                  ...
                  <Pagination :links="dataRefTitles.links" />
                </div>
              </div>
            </keep-alive>
          </b-card>
...
export default {
  ...
  metaInfo: { title: "Admin Reference Title" },
  data() {
    return {
      tabIndexCfgHome: 0,
      form: {
  ...
  methods: {
    ...
    showMsgBoxDelete: function (id) {
      this.$bvModal
        .msgBoxConfirm("Please confirm that you want to delete this title.", {
